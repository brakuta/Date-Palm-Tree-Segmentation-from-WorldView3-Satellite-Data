# Auto-generated canonical config: UPerNet + Swin-Base
...
model = dict(
    ...
    backbone=dict(
        type='SwinTransformer', pretrain_img_size=384, in_channels=3,
        embed_dims=128, patch_size=4, window_size=12, mlp_ratio=4,
