# Auto-generated canonical config: Mask2Former + Swin-B
...
# Mask2Former (Swin-B). Query-based head: for the toolkit's tree-counting /
...
model = dict(
    ...
    backbone=dict(
        type='SwinTransformer', pretrain_img_size=224, in_channels=8,
        embed_dims=128, patch_size=4, window_size=7, mlp_ratio=4,
        depths=[2, 2, 18, 2], num_heads=[4, 8, 16, 32], strides=(4, 2, 2, 2),
    ...
    decode_head=dict(
        type='Mask2FormerHead', in_channels=[128, 256, 512, 1024],
